...
public class Animal extends Actor {
	...
	public void act(long now) {
		setBoundaries();
		characterDeath(carDeath,waterDeath,now);
		deathCondition(noMove);

	}

	/**
	 * function to mark that all holes have been filled
	 * @return end value
	 */
	...
	/**
	 * function to inform that the score needs to be updated
	...
	/**
	 * Sets the boundaries for the character
	 */
	...
	/**
	 * Handling character death events
	 * @param carDeath boolean for death by car/truck
	 * @param waterDeath boolean for death by water
	 * @param now the timer state now
	 */
	public void characterDeath(boolean carDeath, boolean waterDeath, long now){
		if (carDeath) {
			noMove = true;
			if ((now)% 11 ==0) {
				carD++;
	...
	/**
	 * Checking if the character hits any obstacle
	 * @param noMove boolean for frog life status
	 */
	public void deathCondition(boolean noMove){
